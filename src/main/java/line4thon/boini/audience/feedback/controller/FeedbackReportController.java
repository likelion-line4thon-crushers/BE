...
import line4thon.boini.audience.feedback.dto.response.FeedbackListResponse;
...
public class FeedbackReportController {
  ...
  public BaseResponse<FeedbackListResponse> getFeedbacks(@PathVariable String roomId) {
